...
### Define LLM Model and System promtps
...
### This function defines how our chatbot responds to user messages.
...
def update_plot(event):
    '''
    This function is used to update the figure
    '''
    matplotlib_pane.object = exec_with_return(event.new)


### Define widgets(For Panel)
